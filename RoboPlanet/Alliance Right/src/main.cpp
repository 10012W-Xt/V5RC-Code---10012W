...
// Move to the corner 3 blocks
chassis.moveToPoint(0,14,1000);
chassis.turnToPoint(1.5,19,1000,{.maxSpeed = 70});
intake_top.move(-34);
intake_bottom.move(120);
chassis.moveToPoint(12,30,1000, {.maxSpeed = 50});
//Match Loader to make sure all blocks are collected
pros::delay(500);
loader.set_value(true);
//Go to Loader
chassis.turnToPoint(35,0.6,500);
chassis.moveToPoint(30,0.6,1000,{.maxSpeed = 80});
chassis.turnToPoint(33, -20, 1000);
chassis.waitUntil(10);
chassis.waitUntilDone();
//Go into Loader   
chassis.moveToPoint(33,-15,500,{.maxSpeed = 60});
chassis.moveToPoint(33,-15,1000,{ .maxSpeed = 50});
pros::delay(900);
//Go to Long Goal
chassis.moveToPoint(32,25,1000,{.forwards = false, .maxSpeed = 120});
chassis.waitUntilDone();
...
chassis.moveToPoint(30,11,1000);
chassis.turnToPoint(41,15,1000,{.maxSpeed = 80});
chassis.moveToPoint(42,14,1000,{.maxSpeed = 80});
chassis.turnToPoint(42,20,1000,{.maxSpeed = 80});
chassis.moveToPoint(43,40,1000,{.maxSpeed = 60});
